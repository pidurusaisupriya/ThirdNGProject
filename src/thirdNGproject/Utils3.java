...
public class Utils3 {
	...
	public static String DRIVER_PATH = "D:\\Personal\\SupriyaTraining\\Selenium\\chromedriver-selenium-v66.exe";
	
	public static String DRIVER_NAME = "webdriver.chrome.driver";//Driver name
	...
	public static final int WAIT_TIME = 10; // Delay time to wait the website
    // launch completely
public static final String BASE_URL = "http://www.demo.guru99.com/v4/";
public static final String EXPECT_ID = "mngr137052";
